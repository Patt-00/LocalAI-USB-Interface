...
set "TOKENFILE=%WORK_BASE%\api-key"
...
set "LOCALAI_TOKENFILE=%TOKENFILE%"
...
set /p API_KEY=<"%TOKENFILE%"
start "" "%URL%/?launch=%RANDOM%%RANDOM%&bundle=%UI_BUNDLE%#apiKey=%API_KEY%"
echo.
...
goto :ERROR_END
:SERVER_EXITED
del /q "%PIDFILE%" "%TOKENFILE%" >nul 2>&1
